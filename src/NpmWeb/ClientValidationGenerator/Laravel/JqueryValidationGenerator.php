    ...
    extends \NpmWeb\ClientValidationGenerator\BaseJqueryValidationGenerator
{
    ...
    protected function generateClientValidatorRules( $allRules, array $options = null ) {
